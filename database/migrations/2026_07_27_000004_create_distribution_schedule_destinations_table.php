...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('distribution_schedule_destinations', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('distribution_schedule_id')->constrained(indexName: 'dsd_schedule_id_foreign')->cascadeOnDelete();
            ...
            $table->unique(['distribution_schedule_id', 'location_id'], 'dsd_schedule_location_unique');
            $table->unique(['distribution_schedule_id', 'recipient_id'], 'dsd_schedule_recipient_unique');
        });
    }
