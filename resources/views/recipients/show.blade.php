                ...
                <x-card title="Status Keaktifan" subtitle="Kontrol distribusi">
                    ...
                    <x-slot name="footer">
                        <div class="w-full space-y-2">
                            ...
                            <form method="POST" action="{{ route('recipients.force-delete', $recipient) }}" class="w-full"
                                  onsubmit="return confirm('HAPUS PERMANEN penerima {{ addslashes($recipient->name) }}? Data yang sudah dihapus tidak bisa dikembalikan.');">
                                @csrf
                                @method('DELETE')
