                ...
                <x-card title="Status & Pengawasan" subtitle="Tindakan administratif">
                    ...
                    <x-slot name="footer">
                        <div class="w-full space-y-2">
                            ...
                            <form method="POST" action="{{ route('locations.force-delete', $location) }}" class="w-full"
                                  onsubmit="return confirm('HAPUS PERMANEN lokasi {{ addslashes($location->name) }}? Data yang sudah dihapus tidak bisa dikembalikan.');">
                                @csrf
                                @method('DELETE')
